...
func TestDefaultIntelSignerIdentityRegexp_AcceptsAndRejects(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			identity: "https://github.com/Chain305/chainsaw/.github/workflows/release.yml@refs/tags/v2026.05.01",
			want:     true,
		},
		{
			name:     "canonical release tag (.yaml spelling)",
			identity: "https://github.com/Chain305/chainsaw/.github/workflows/release.yaml@refs/tags/v1",
			want:     true,
		},
		{
			name:     "lowercase owner casing — (?i) accepts (GitHub may emit chain305)",
			identity: "https://github.com/chain305/chainsaw/.github/workflows/release.yml@refs/tags/v1",
			want:     true,
		},
		{
			name:     "branch ref instead of tag ref — must reject (the regexp pins refs/tags/)",
			identity: "https://github.com/Chain305/chainsaw/.github/workflows/release.yml@refs/heads/main",
			want:     false,
		},
		{
			name:     "policy-signer workflow — wrong surface, must reject",
			identity: "https://github.com/Chain305/chainsaw/.github/workflows/sign-policy-bundle.yml@refs/heads/main",
			want:     false,
		},
		{
			name:     "wrong owner",
		...
		{
			name:     "wrong repo under right owner",
			identity: "https://github.com/Chain305/evil/.github/workflows/release.yml@refs/tags/v1",
			want:     false,
		},
		{
			name:     "subdomain spoof",
			identity: "https://github.com.attacker.tld/Chain305/chainsaw/.github/workflows/release.yml@refs/tags/v1",
			want:     false,
		},
		{
			name:     "http not https — must reject",
			identity: "http://github.com/Chain305/chainsaw/.github/workflows/release.yml@refs/tags/v1",
			want:     false,
		},
		{
			name:     "missing ref suffix",
			identity: "https://github.com/Chain305/chainsaw/.github/workflows/release.yml",
			want:     false,
		},
